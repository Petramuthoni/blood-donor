...
import com.example.blood.fragments.AchievmentsView;
import com.example.blood.fragments.BloodInfo;
import com.example.blood.fragments.HomeView;
import com.example.blood.fragments.NearByHospitalActivity;
import com.example.blood.fragments.SearchDonorFragment;
import com.example.blood.message;
import com.example.blood.viewmodels.UserData;
...
public class Dashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent i=new Intent(Dashboard.this,call.class);
            startActivity(i);
        }
        else if(id == R.id.sms){
